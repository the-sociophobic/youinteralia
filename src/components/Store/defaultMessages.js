  ...
  Artist: {
    ...
    Olga: [
      <>
        ...
        <br />
        <b>1. Выход из метро Гостиный двор</b><br />
        ...
        <br />
        <b>2. Улица Марата (напротив Музея Арктики и Антарктики)<br />Недействующая автобусная остановка</b><br />
        ...
        <br />
        <b>3. Подъезд дома Марата 33</b><br />
  ...
  Archive: {
    ...
    desc: [
      <>
        ...
        <br /><br />
        Архив составлен из отобранных художниками материалов, которые или непосредственно связаны с их проектами для «You, inter alia», или раскрывают их практику в целом.
        <br />
