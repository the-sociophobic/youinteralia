...
const artists = [
  ...
  },
  {
    ...
    aboutArtist: [
      <>
        ...
        <br/><br/>
        почитать:<br/>
        <Link newTab to="https://syg.ma/@ian-kubra-1">syg.ma</Link>
        <Link newTab to="http://wordorder.ru/catalog-ru/poeziya/sady-i-molnii/">wordorder.ru</Link>
        <Link newTab to="https://greza.space/poslepoludennyj-otdyh-budushhego/">greza.space/</Link>
        <Link newTab to="http://fajro.online/index.html">fajro.online</Link>
        <br/>послушать:<br/>
        <Link newTab to="https://soundcloud.com/jungletriangle">soundcloud.com</Link>
        <Link newTab to="https://iankubra.bandcamp.com/ ">bandcamp.com: iankubra</Link>
        <Link newTab to="https://aestastantra.bandcamp.com/">bandcamp.com: aestastantra</Link>
        <Link newTab to="https://aguirrerecords.bandcamp.com/album/ou-du-monde">bandcamp.com: aguirrerecords, ou-du-monde</Link>
        <Link newTab to="https://shimmeringmoodsrecords.bandcamp.com/album/current-double-hermetic-songs">bandcamp.com: shimmeringmoodsrecords current-double-hermetic-songs</Link>
        <Link newTab to="https://shimmeringmoodsrecords.bandcamp.com/album/vaya-adelante">bandcamp.com: shimmeringmoodsrecords vaya-adelante</Link>
        <br/>посмотреть:<br/>
        Pleroma (feature 54 min)<br/>
        <Link newTab to="https://vimeo.com/128005569">vimeo.com/128005569</Link>
        <Link newTab to="https://vimeo.com/suncalpa">vimeo.com/suncalpa</Link>
        <Link newTab to="https://www.youtube.com/user/oudumonde">youtube</Link>
      </>,
      <>
  ...
  },
  {
    ...
    aboutRoute: [
      "Égalité\n\nПроект создан в соавторстве с Владой Миловской, Лейлой Алиевой и Игнатом Хлобыстиным. Это аудио-спекталь по первой части рассказа Ольги Житлиной «Адар». В ней описывается встреча и неожиданный момент родства в отчаянии с бездомным. Адресат рассказа двоится: это то оставшийся без крова человек, то отдаляющийся возлюбленный. В некотором смысле этот письмо бездомному. Говорение от первого лица в спектакле также не происходит из статичной точки. Героиня, как бродяга, блуждает по городу, впадая то в отчаяние, то в радостное возбуждение. То занимая позицию власти, то теряя почву под ногами.",
      "Égalité\n\nÉgalité is co-authored with Vlada Milovskaya, Leila Alieva, Ignat Khlobystin and is an audio-performance based on the first part of Olga Jitlina story «Adar». It describes the encounter and the experience of unintended kinship in distress with a homeless person. The addressee of the story is twofold: it is both, the person left out in a cold with no place to go, and a lover pulling away. In a sense, this is a letter addressed to a homeless person, yet the one who speaks does so from a placeless (homeless) position also. Like a hobo, the protagonist wanders around the city, at times falling into a despair, at others—into blissful exaltation, either taking a position of power, or losing ground.",
    ],
  },

  {
    ...
    aboutArtist: [
      <>
        ...
        <br />
        Личный сайт: <Link newTab to="https://marioniandrea.art">marioniandrea.art</Link> <br />
        Кураторский проект: <Link newTab to="http://lumpenstation.art">lumpenstation.art</Link>
      </>,
      <>
  ...
  },
  {
    ...
    aboutArtist: [
      <>
        ...
        <br /><br />
        <Link newTab to="http://www.carlademierre.ch">carlademierre.ch</Link>
      </>,
      <>
  ...
  },
  {
    ...
    aboutArtist: [
      <>
        ...
        <br /><br />
        <Link newTab to="https://www.martinamaechler.com">martinamaechler.com</Link>
      </>,
      <>
